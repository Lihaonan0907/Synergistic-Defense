...
def run(
    ...
    for i, c in enumerate(ap_class):
        ...
        if c < nc:
            ...
            LOGGER.warning(f"Class {c} is out of range for nc={nc}, skipping")
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'base.pt', help='model path(s)')
    ...
    parser.add_argument('--project', default=ROOT / 'runs/Defense_val', help='save to project/name')
    parser.add_argument('--name', default='exp', help='save to project/name')
    parser.add_argument('--exist-ok', action='store_true', help='existing project/name ok, do not increment')
    parser.add_argument('--half', action='store_true', help='use FP16 half-precision inference')
    parser.add_argument('--dnn', action='store_true', help='use OpenCV DNN for ONNX inference')
    parser.add_argument('--NFSI',default=0, action='store_true', help='using NFSI strategy')
